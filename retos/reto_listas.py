...
La función debe devolver una nueva lista que contenga solo los números de la lista original 
...
Puedes empezar creando una función que reciba los dos parámetros y luego utilizar un bucle 
para recorrer la lista original y añadir a una nueva lista solo los elementos que cumplan la condición.
