"""
    Crea una función llamada calcular_area_circulo que reciba como parámetro el radio de un círculo y devuelva su área. 
    Recuerda que el área de un círculo se calcula como π multiplicado por el radio al cuadrado (π * r²). 
    Utiliza el valor 3.14159 para π.
...
radio_usuario = input ("Introduce el radio:")


# Convertir la entrada a número decimal
radio_usuario_float = float(radio_usuario)


# Llamar a la función con el radio del usuario
area_usuario = calcular_area_circulo(radio_usuario_float)
